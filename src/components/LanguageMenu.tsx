  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-7 items-center gap-1.5 rounded-full px-2 text-[10px] font-medium uppercase leading-none tracking-[0.03em] text-gray-500 transition hover:bg-gray-50 hover:text-primary-700"
      >
      ...
      {open ? (
        <div className="absolute right-0 top-9 z-50 min-w-32 overflow-hidden rounded-xl border border-gray-200 bg-white p-1.5 shadow-lg shadow-primary-900/5">
          {locales.map(item => (
            <a
              key={item}
